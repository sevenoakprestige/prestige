        ...
        <>
            ...
            <section className="section-dark relative min-h-[90vh] flex flex-col justify-center overflow-hidden pt-32 pb-0 sm:pt-40 lg:pt-48">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/assets/services/vat.webp" alt="UK VAT Registration Service" fill className="object-cover object-center" priority quality={85} />
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
                    <div className="max-w-2xl text-left">
                        ...
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-2 backdrop-blur-sm">
                            ...
                            <span className="text-sm font-medium text-gold">Tax Registration</span>
                        </div>
                        ...
                        <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl uppercase tracking-wider font-light">
                            UK VAT REGISTRATION SERVICE<br/>
                ...
                <div className="relative z-10 mt-20 w-full border-t border-gold/20 bg-background/40 backdrop-blur-md pt-8 pb-8 hidden lg:block">
                    <div className="mx-auto max-w-7xl grid grid-cols-1 gap-8 md:grid-cols-4 px-4 sm:px-6 lg:px-8">
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">HMRC REGISTRATION</h3>
                                <p className="text-xs text-muted-foreground">Fast & compliant UK VAT registration</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">TAX COMPLIANCE</h3>
                                <p className="text-xs text-muted-foreground">Guidance on VAT thresholds and schemes</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">CROSS-BORDER</h3>
                                <p className="text-xs text-muted-foreground">Support for non-resident businesses</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">EXPERT SUPPORT</h3>
                                <p className="text-xs text-muted-foreground">Ongoing guidance for your business</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">VAT OVERVIEW</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">Why Register for VAT?</h2>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-border bg-card/25 p-8 backdrop-blur-md transition-all duration-500 hover:border-gold/40 sm:p-10">
                        <div className="space-y-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
                            <p>UK businesses with a taxable turnover above the VAT threshold are required to register for VAT with HMRC. Some businesses choose to register voluntarily even below the threshold to reclaim VAT on purchases and project a more established business image.</p>
                            <p>Our VAT registration service handles the application process with HMRC, ensuring all required information is accurately submitted for a smooth registration experience.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">OUR SERVICE</span>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        {[
                            ...
                            "Assistance with VAT Scheme Selection",
                            "Ongoing Support",
                        ].map((item, index) => (
            ...
            <section className="section-dark relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
                <div className="mx-auto max-w-4xl text-center">
                    <h2 className="font-display mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-foreground">Register for VAT Today</h2>
                    <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl lg:text-2xl">Fast, compliant VAT registration with HMRC.</p>
