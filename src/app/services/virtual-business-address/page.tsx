        ...
        <>
            ...
            <section className="section-dark relative min-h-[90vh] flex flex-col justify-center overflow-hidden pt-32 pb-0 sm:pt-40 lg:pt-48">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/assets/services/vba.webp" alt="Virtual Business Address UK" fill className="object-cover object-center" priority quality={85} />
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
                    <div className="max-w-2xl text-left">
                        ...
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-2 backdrop-blur-sm">
                            ...
                            <span className="text-sm font-medium text-gold">Business Presence</span>
                        </div>
                        ...
                        <h1 className="mb-6 font-display text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl md:text-6xl">
                            Build a Strong <br className="hidden sm:block"/>
                            <span className="text-gold">UK Business Identity.</span>
                        </h1>

                        <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl font-light">
                            Project a premium business presence with our prestigious virtual business address.
                        </p>
            ...
            <section className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">BRANDING</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">Build a Strong UK Business Identity</h2>
            ...
            <section className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">USE CASES</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">Use Your Address For</h2>
                        <div className="mx-auto h-px w-24 rule-gold mb-6" />
                    </div>
            ...
            <section className="section-dark relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
                <div className="mx-auto max-w-4xl text-center">
                    <h2 className="font-display mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-foreground">Get Your Virtual Business Address</h2>
                    <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl lg:text-2xl">Project a professional UK business presence from anywhere.</p>
