...
export const metadata: Metadata = {
  title: "Trust & Security | Seven Oak Prestige",
  description: "How we protect your data and how you can verify us. Plainly stated security practices and regulatory position.",
};
