    ...
    const cards = [
        {
            ...
            heading: "NOUS CONTACTER PAR E-MAIL",
            link: { href: "mailto:contact@sevenoakprestige.com", label: "contact@sevenoakprestige.com", external: false },
            desc: "Envoyez-nous un e-mail à tout moment — notre équipe répondra dans les 24 heures.",
        },
        {
            icon: (
            ...
            desc: "Discutez avec notre équipe instantanément pour des conseils rapides. Disponible 24/7.",
        },
        {
            icon: (
            ...
            desc: "Assistance basée au Royaume-Uni pour les demandes commerciales.",
        },
    ];
            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mb-16 text-center">
                    ...
                    <p className="mt-4 text-muted-foreground">
                        Nous sommes là pour vous aider avec tous vos besoins de création d'entreprise.
                    </p>
                </div>
                ...
                <div className="mt-20 max-w-2xl mx-auto">
                    <LeadForm source="Main Contact Page" title="Envoyez-nous un message" lang="fr" />
                </div>
            </div>
        </section>
    );
