...
const benefitsIcons = [
    <FaShieldAlt key="privacy" className="h-6 w-6" />,
    <FaBuilding key="image" className="h-6 w-6" />,
    <FaEnvelope key="mail" className="h-6 w-6" />,
];

export default function RegisteredOfficeService() {
    const { t } = useTranslation();
    const data = t.servicesPages.registeredOffice;
            ...
            <section className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-7xl">
                    <div className="mb-10 text-center lg:mb-12">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">{data.benefits.eyebrow}</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">{data.benefits.title}</h2>
                        <div className="mx-auto h-px w-24 rule-gold mb-6" />
                    </div>
