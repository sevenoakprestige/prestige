...
export default function EORIRegistration() {
    ...
    const data = t.servicesPages.eoriRegistration;
        ...
        <>
            ...
            <section className="section-dark relative min-h-[90vh] flex flex-col justify-center overflow-hidden pt-32 pb-0 sm:pt-40 lg:pt-48">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/assets/services/eori.webp" alt="UK EORI Registration Service" fill className="object-cover object-center" priority quality={85} />
