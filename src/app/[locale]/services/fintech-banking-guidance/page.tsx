...
const platformsIcons = [
    <FaCreditCard key="stripe" className="h-6 w-6" />,
    <FaGlobeAmericas key="wise" className="h-6 w-6" />,
    <FaShieldAlt key="revolut" className="h-6 w-6" />,
];

export default function FintechBankingGuidance() {
    const { t } = useTranslation();
    const data = t.servicesPages.fintechBankingGuidance;
    ...
    return (
        <>
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
                    <div className="max-w-2xl text-left">
                        ...
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-2 backdrop-blur-sm">
                            ...
                            <span className="text-sm font-medium text-gold">{data.hero.badge}</span>
                        </div>
                ...
                <div className="relative z-10 mt-20 w-full border-t border-gold/20 bg-background/40 backdrop-blur-md pt-8 pb-8 hidden lg:block">
                    <div className="mx-auto max-w-7xl grid grid-cols-1 gap-8 md:grid-cols-4 px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">{data.bottomBar[3].title}</h3>
                                <p className="text-xs text-muted-foreground">{data.bottomBar[3].desc}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">{data.overview.eyebrow}</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">{data.overview.title}</h2>
            ...
            <section className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-7xl">
                    <div className="mb-10 text-center lg:mb-12">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">{data.platforms.eyebrow}</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">{data.platforms.title}</h2>
                        <div className="mx-auto h-px w-24 rule-gold mb-6" />
                    </div>
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 lg:gap-8">
                        {data.platforms.items.map((item, index) => (
            ...
            <section className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">{data.whatsIncluded.eyebrow}</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">{data.whatsIncluded.title}</h2>
                        <div className="mx-auto h-px w-24 rule-gold mb-6" />
                    </div>
