    ...
    return (
        <section className="py-16 lg:py-20 border-t border-white/10 relative overflow-hidden">
            <div className="absolute inset-0 z-0">
                <div className="absolute inset-0 bg-[url('/london-hero.jpg')] bg-cover bg-center"></div>
            ...
            <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                    ...
                    <Button asChild size="lg" variant="outline" className="h-12 border border-white/30 bg-transparent px-8 text-sm font-bold text-white hover:bg-white/10 transition-all w-full sm:w-auto rounded-md">
                        <Link 
