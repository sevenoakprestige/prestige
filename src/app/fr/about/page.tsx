...
const services = [
    {
        ...
        title: "Création d'Entreprise au Royaume-Uni",
        description: "Création de société rapide et conforme avec la Companies House pour les résidents britanniques et les non-résidents.",
        href: "/fr/services/uk-company-formation-for-non-residents",
    },
    {
        icon: <FaMapMarkerAlt className="h-7 w-7" />,
        title: "Adresse de Siège Social",
        description: "Une adresse de siège social professionnelle au 124 City Road, Londres — entièrement conforme aux exigences de la Companies House.",
        href: "/fr/services/registered-office-service",
    },
    {
        icon: <FaUserTie className="h-7 w-7" />,
        title: "Adresse de Service pour Directeur",
        description: "Protégez votre adresse personnelle avec une adresse de service de directeur professionnelle pour les dépôts de la Companies House.",
        href: "/fr/services/director-service-address",
    },
    {
        icon: <FaCity className="h-7 w-7" />,
        title: "Adresse Commerciale Virtuelle",
        description: "Une adresse commerciale prestigieuse à Londres pour votre correspondance, donnant à votre entreprise une présence professionnelle au Royaume-Uni.",
        href: "/fr/services/virtual-business-address",
    },
    {
        icon: <FaShieldAlt className="h-7 w-7" />,
        title: "Aide à la Conformité",
        description: "Des conseils d'experts sur la conformité de la Companies House, la vérification de l'identité et les exigences réglementaires en cours.",
        href: "/fr/services/companies-house-verification",
    },
    {
        icon: <FaUniversity className="h-7 w-7" />,
        title: "Assistance Bancaire",
        description: "Soutien pratique dans la préparation des demandes bancaires professionnelles britanniques et de l'ouverture de comptes fintech.",
        href: "/fr/services/fintech-banking-guidance",
    },
];
...
const approach = [
    ...
    "Préparation commerciale à long terme",
];

const whyChoose = [
    {
        icon: <FaBolt className="h-7 w-7" />,
        title: "Aide Rapide à la Création",
        description: "Assistance efficace à la création d'entreprise, conçue pour faire enregistrer votre entreprise britannique rapidement et professionnellement.",
    },
    {
        icon: <FaGlobe className="h-7 w-7" />,
        title: "Expertise Internationale",
        description: "Nous travaillons avec des entrepreneurs de divers pays souhaitant créer des sociétés britanniques et renforcer leur crédibilité internationale.",
    },
    {
        icon: <FaBuilding className="h-7 w-7" />,
        title: "Présence Professionnelle au R-U",
        description: "Des adresses commerciales premium à Londres qui confèrent à votre entreprise la crédibilité et le professionnalisme qu'elle mérite.",
    },
    {
        icon: <FaShieldAlt className="h-7 w-7" />,
        title: "Axé sur la Conformité",
        description: "Chaque service que nous fournissons s'articule autour de la conformité réglementaire britannique, garantissant que votre entreprise est correctement structurée dès le premier jour.",
    },
    {
        icon: <FaUniversity className="h-7 w-7" />,
        title: "Assistance Bancaire",
        description: "Soutien pratique à la préparation bancaire pour vous aider à vous préparer aux demandes de services bancaires et fintech britanniques.",
    },
    {
        icon: <FaHandshake className="h-7 w-7" />,
        title: "Support Client Réactif",
        description: "Une approche centrée sur le client avec une communication claire et opportune à chaque étape du parcours de votre entreprise.",
    },
];
            ...
            <section className="section-dark relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4 py-32 sm:px-6 lg:px-8">
                ...
                <div className="relative z-10 mx-auto max-w-5xl text-center">
                    ...
                    <p className="mx-auto mb-10 max-w-3xl text-lg leading-relaxed text-foreground/80 sm:text-xl md:text-2xl">
                        Accompagnement des entrepreneurs dans la création de sociétés au Royaume-Uni, services de siège social, conseils en conformité et assistance bancaire.
                    </p>
                    ...
                    <div className="mt-14 flex flex-wrap items-center justify-center gap-6 text-sm sm:gap-10">
                        {["Entreprise Enregistrée au R-U", "Conforme à la Companies House", "Clients Internationaux Pris en Charge"].map((item) => (
                    ...
                    <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                        ...
                        <div>
                            ...
                            <div className="space-y-5 text-base leading-relaxed text-muted-foreground sm:text-lg">
                                <p>
                                    Seven Oak Prestige LTD accompagne les résidents britanniques et les entrepreneurs internationaux dans la création d'entreprises au Royaume-Uni, les services de siège social, les adresses de service pour directeurs, les adresses commerciales virtuelles, les conseils en conformité et l'assistance bancaire.
                                </p>
                                <p>
                                    Nous comprenons que l'établissement d'une entreprise ne se limite pas à la simple création d'une société. Il s'agit de créer les bonnes bases pour la croissance future, la crédibilité et les opportunités.
                                </p>
                                <p>
                                    Que vous lanciez votre première entreprise, que vous vous développiez à l'international ou que vous établissiez une présence au Royaume-Uni, notre objectif est de rendre le processus clair, professionnel et efficace.
                                </p>
                            </div>
                            ...
                            <div className="mt-10">
                                ...
                                <p className="mb-5 text-muted-foreground leading-relaxed">
                                    Chez Seven Oak Prestige LTD, nous nous concentrons sur l'accompagnement des entrepreneurs avec confiance à chaque étape importante. Notre approche repose sur :
                                </p>
                                ...
                                <p className="mt-6 text-muted-foreground italic leading-relaxed">
                                    Nous croyons que des entreprises solides se construisent sur des fondations solides.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-4 left-6 rounded-2xl border border-gold/30 bg-card/90 px-5 py-4 shadow-xl backdrop-blur-md">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-bold text-gold tracking-wider uppercase">Enregistrée en</p>
                ...
                <div className="mx-auto max-w-7xl">
                    <div className="mb-14 text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-muted-foreground text-lg">
                            En combinant les services de création d'entreprise et un accompagnement pratique, nous aidons les entrepreneurs à établir une présence professionnelle au Royaume-Uni dès le début.
                        </p>
                    </div>
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <div className="space-y-5 text-base leading-relaxed text-muted-foreground sm:text-lg">
                                <p className="text-xl font-medium text-foreground">
                                    Relier les entrepreneurs mondiaux aux opportunités au Royaume-Uni.
                                </p>
                                <p>
                                    Le Royaume-Uni reste l'un des environnements commerciaux les plus reconnus au monde. Nous travaillons avec des entrepreneurs de divers pays qui souhaitent créer une société britannique et renforcer leur crédibilité sur les marchés internationaux.
                                </p>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-4">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <span className="font-semibold text-foreground text-sm uppercase tracking-wide">Expertise en<br />Affaires UK</span>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gold/10 border border-gold/20 text-gold">
                                            <FaShieldAlt className="h-5 w-5" />
                                        </div>
                                        <span className="font-semibold text-foreground text-sm uppercase tracking-wide">Conforme &<br />De Confiance</span>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gold/10 border border-gold/20 text-gold">
                                            <FaHandshake className="h-5 w-5" />
                                        </div>
                                        <span className="font-semibold text-foreground text-sm uppercase tracking-wide">Partenariat<br />À Long Terme</span>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="section-parchment border-y border-border relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
                ...
                <div className="mx-auto max-w-7xl">
                    <div className="mb-14 text-center">
                        ...
                        <div className="mx-auto mb-5 h-px w-24 rule-gold" />
                        <p className="mx-auto max-w-2xl text-muted-foreground text-lg">
                            Notre objectif n'est pas seulement de vous aider à créer une entreprise, mais de soutenir les entrepreneurs dans la création d'une structure commerciale préparée pour les opportunités futures.
                        </p>
                    </div>
            ...
            <section className="section-dark relative overflow-hidden px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
                ...
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    <p className="mx-auto mb-10 max-w-2xl text-lg text-foreground/75 sm:text-xl">
                        Création d'Entreprise au Royaume-Uni &bull; Adresses Commerciales &bull; Conseils en Conformité &bull; Assistance Bancaire
                    </p>
                    ...
                    <div className="mt-12 inline-flex flex-col items-center gap-4 rounded-2xl border border-[#00B67A]/20 bg-gradient-to-b from-white/10 to-transparent px-10 py-6 backdrop-blur-md shadow-xl transition-transform hover:scale-[1.02]">
                        ...
                        <p className="text-foreground/70 text-sm max-w-sm text-center">
                            Nous apprécions vos retours. Laissez un avis sur <strong>Trustpilot</strong>, cela prend moins d'une minute.
                        </p>
                        <Link
