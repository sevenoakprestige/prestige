...
const included = [
    "Adresse officielle de siège social au Royaume-Uni",
    "Traitement et réexpédition du courrier",
    "Utilisation pour la conformité Companies House",
    "Gardez votre adresse personnelle hors des registres publics",
    "Présence commerciale professionnelle à Londres",
];

const benefits = [
    { icon: <FaShieldAlt className="h-6 w-6" />, title: "Protection de la vie privée", description: "Gardez votre adresse résidentielle personnelle hors du registre public de la Companies House." },
    { icon: <FaBuilding className="h-6 w-6" />, title: "Image Professionnelle", description: "Une adresse commerciale à Londres renforce la confiance et la crédibilité auprès des clients et partenaires." },
    { icon: <FaEnvelope className="h-6 w-6" />, title: "Traitement du Courrier", description: "Toute la correspondance officielle reçue à votre siège social est traitée de manière professionnelle." },
];

export default function RegisteredOfficeServiceFR() {
    return (
        <>
            {/* ── HERO SECTION ── */}
            <section className="section-dark relative min-h-[90vh] flex flex-col justify-center overflow-hidden pt-32 pb-0 sm:pt-40 lg:pt-48">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/assets/services/register_office_address.webp" alt="Service d'Adresse de Siège Social au Royaume-Uni" fill className="object-cover object-center" priority quality={85} />
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 mb-20">
                    <div className="max-w-2xl text-left">
                        ...
                        <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl uppercase tracking-wider font-light">
                            ADRESSE PROFESSIONNELLE À LONDRES POUR<br/>
                            VOTRE SOCIÉTÉ BRITANNIQUE
                        </p>
                    ...
                    <div className="mx-auto max-w-7xl grid grid-cols-1 gap-8 md:grid-cols-4 px-4 sm:px-6 lg:px-8">
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">Adresse commerciale prestigieuse à Londres EC1</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">VIE PRIVÉE PROTÉGÉE</h3>
                                <p className="text-xs text-muted-foreground">Gardez votre adresse personnelle hors des registres publics</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">RÉEXPÉDITION DU COURRIER</h3>
                                <p className="text-xs text-muted-foreground">Traitement sécurisé de la correspondance officielle</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">CONFORMITÉ TOTALE</h3>
                                <p className="text-xs text-muted-foreground">Répond à toutes les exigences de la Companies House</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="privacy-section" className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">CONFIDENTIALITÉ</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">Protégez Votre Vie Privée avec une Adresse Commerciale au Royaume-Uni</h2>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-border bg-card/25 p-8 backdrop-blur-md transition-all duration-500 hover:border-gold/40 sm:p-10">
                        <div className="space-y-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
                            <p>Toute société Limited et LLP britannique doit avoir une adresse de siège social officielle enregistrée auprès de la Companies House. Cette adresse est utilisée par la Companies House, le HMRC et d'autres organismes gouvernementaux pour envoyer la correspondance statutaire et les avis officiels.</p>
                            <p>Notre prestigieuse adresse de siège social à Londres EC1 répond pleinement à cette exigence légale, permet de garder votre adresse personnelle hors du registre public et garantit que votre courrier officiel important vous est transféré en toute sécurité.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">INCLUS</span>
            ...
            <section className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-7xl">
                    <div className="mb-10 text-center lg:mb-12">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">AVANTAGES</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">Avantages d'une Adresse Commerciale à Londres</h2>
                        <div className="mx-auto h-px w-24 rule-gold mb-6" />
                    </div>
            ...
            <section className="section-dark relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
                <div className="mx-auto max-w-4xl text-center">
                    <h2 className="font-display mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-foreground">Obtenez Votre Adresse de Siège Social</h2>
                    <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl lg:text-2xl">Protégez votre vie privée avec une adresse professionnelle à Londres.</p>
