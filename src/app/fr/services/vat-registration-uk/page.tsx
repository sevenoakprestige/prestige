...
import { FaWhatsapp, FaCheck, FaFileInvoiceDollar, FaShieldAlt, FaGlobe, FaHandsHelping } from "react-icons/fa";
import Footer from "@/components/Footer";

export default function VATRegistrationFR() {
    return (
        <>
            {/* ── HERO SECTION ── */}
            <section className="section-dark relative min-h-[90vh] flex flex-col justify-center overflow-hidden pt-32 pb-0 sm:pt-40 lg:pt-48">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/assets/services/vat.webp" alt="Service d'Enregistrement TVA UK" fill className="object-cover object-center" priority quality={85} />
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
                    <div className="max-w-2xl text-left">
                        ...
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-2 backdrop-blur-sm">
                            ...
                            <span className="text-sm font-medium text-gold">Inscription Fiscale</span>
                        </div>
                        ...
                        <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl uppercase tracking-wider font-light">
                            SERVICE D'ENREGISTREMENT TVA UK<br/>
                            AVEC CONFORMITÉ HMRC
                        </p>
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row">
                            ...
                            <Link href="https://buy.stripe.com/aFafZ9bwY5nvdAx3pafw40o" target="_blank" className="btn-gold">
                    ...
                    <div className="mx-auto max-w-7xl grid grid-cols-1 gap-8 md:grid-cols-4 px-4 sm:px-6 lg:px-8">
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                                <FaFileInvoiceDollar className="h-5 w-5 text-gold" />
                            </div>
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">ENREGISTREMENT HMRC</h3>
                                <p className="text-xs text-muted-foreground">Inscription rapide et conforme à la TVA britannique</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">CONFORMITÉ FISCALE</h3>
                                <p className="text-xs text-muted-foreground">Conseils sur les seuils et les régimes de TVA</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                                <FaGlobe className="h-5 w-5 text-gold" />
                            </div>
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">TRANSFRONTALIER</h3>
                                <p className="text-xs text-muted-foreground">Assistance pour les entreprises non-résidentes</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                                <FaHandsHelping className="h-5 w-5 text-gold" />
                            </div>
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">SUPPORT D'EXPERTS</h3>
                                <p className="text-xs text-muted-foreground">Accompagnement continu pour votre entreprise</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative z-10 mt-12 w-full border-t border-gold/20 bg-background/40 backdrop-blur-md py-6 lg:hidden overflow-x-auto snap-x snap-mandatory hide-scrollbar">
                    <div className="flex gap-6 px-4 w-max">
                        <div className="flex items-start gap-3 snap-center w-[250px]">
                            <FaFileInvoiceDollar className="h-6 w-6 text-gold flex-shrink-0 mt-1" />
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">ENREGISTREMENT HMRC</h3>
                                <p className="text-xs text-muted-foreground">Inscription rapide et conforme à la TVA britannique</p>
                            </div>
                        ...
                        <div className="flex items-start gap-3 snap-center w-[250px]">
                            <FaGlobe className="h-6 w-6 text-gold flex-shrink-0 mt-1" />
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">TRANSFRONTALIER</h3>
                                <p className="text-xs text-muted-foreground">Assistance pour les entreprises non-résidentes</p>
                            </div>
                        ...
                        <div className="flex items-start gap-3 snap-center w-[250px]">
                            <FaHandsHelping className="h-6 w-6 text-gold flex-shrink-0 mt-1" />
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">SUPPORT D'EXPERTS</h3>
                                <p className="text-xs text-muted-foreground">Accompagnement continu pour votre entreprise</p>
                            </div>
            ...
            <section className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">APERÇU DE LA TVA</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">Pourquoi S'inscrire à la TVA ?</h2>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-border bg-card/25 p-8 backdrop-blur-md transition-all duration-500 hover:border-gold/40 sm:p-10">
                        <div className="space-y-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
                            <p>Les entreprises britanniques dont le chiffre d'affaires imposable est supérieur au seuil de TVA sont tenues de s'inscrire à la TVA auprès de HMRC. Certaines entreprises choisissent de s'inscrire volontairement, même en dessous du seuil, pour récupérer la TVA sur les achats et projeter une image commerciale plus établie.</p>
                            <p>Notre service d'enregistrement à la TVA gère le processus de demande avec HMRC, en veillant à ce que toutes les informations requises soient soumises avec précision pour une expérience d'enregistrement fluide.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">NOTRE SERVICE</span>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        {[
                            "Demande d'Enregistrement TVA HMRC",
                            "Acquisition du Numéro de TVA",
                            "Conseils de Conformité",
                            "Assistance aux Entreprises Non-Résidentes",
                            "Aide à la Sélection du Régime de TVA",
                            "Support Continu",
                        ].map((item, index) => (
            ...
            <section className="section-dark relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
                <div className="mx-auto max-w-4xl text-center">
                    <h2 className="font-display mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-foreground">Inscrivez-vous à la TVA Aujourd'hui</h2>
                    <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl lg:text-2xl">Inscription rapide et conforme à la TVA avec HMRC.</p>
