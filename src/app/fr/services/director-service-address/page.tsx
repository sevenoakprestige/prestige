...
export default function DirectorServiceAddressFR() {
    return (
        <>
            {/* ── HERO SECTION ── */}
            <section className="section-dark relative min-h-[90vh] flex flex-col justify-center overflow-hidden pt-32 pb-0 sm:pt-40 lg:pt-48">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/assets/services/dsa.webp" alt="Adresse de Service du Directeur UK" fill className="object-cover object-center" priority quality={85} />
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 mb-20">
                    <div className="max-w-2xl text-left">
                        ...
                        <h1 className="mb-6 font-display text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl md:text-6xl">
                            Confidentialité. Protection. <br className="hidden sm:block"/>
                            <span className="text-gold">Tranquillité d'esprit.</span>
                        </h1>
                        
                        <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl font-light">
                            Gardez votre adresse personnelle privée et restez conforme aux exigences de la Companies House.
                        </p>
                ...
                <div className="relative z-10 mt-20 w-full border-t border-gold/20 bg-background/40 backdrop-blur-md pt-8 pb-8 hidden lg:block">
                    <div className="mx-auto max-w-7xl grid grid-cols-1 gap-8 md:grid-cols-3 px-4 sm:px-6 lg:px-8">
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">PROTÉGER L'ADRESSE</h3>
                                <p className="text-xs text-muted-foreground">Gardez votre adresse personnelle privée</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">RESTER CONFORME</h3>
                                <p className="text-xs text-muted-foreground">Conforme à la Companies House</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">CONFIDENTIEL</h3>
                                <p className="text-xs text-muted-foreground">Traitement sécurisé et confidentiel</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="privacy-section" className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">PROTECTION DE LA VIE PRIVÉE</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">Gardez Votre Adresse Personnelle Privée</h2>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-border bg-card/25 p-8 backdrop-blur-md transition-all duration-500 hover:border-gold/40 sm:p-10">
                        <div className="space-y-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
                            <p>Les directeurs de sociétés britanniques sont tenus de fournir une adresse de correspondance qui est enregistrée dans le registre public de la Companies House. Sans adresse de service du directeur, votre adresse personnelle sera publiquement visible par quiconque effectue une recherche sur votre entreprise.</p>
                            <p>Notre service d'adresse du directeur offre une protection complète de la vie privée en utilisant une adresse britannique professionnelle comme adresse de correspondance officielle du directeur, gardant ainsi vos données personnelles hors des registres publics.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">EXIGENCES LÉGALES</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">Conformité aux Réglementations Britanniques</h2>
                        <div className="mx-auto h-px w-24 rule-gold mb-6" />
                    </div>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        {[
                            "Répond aux exigences légales de la Companies House",
                            "Adresse de correspondance professionnelle au Royaume-Uni",
                            "Protection de la vie privée pour les directeurs",
                            "Garde les données personnelles hors du registre public",
                            "Convient aux directeurs britanniques et non-résidents",
                            "Maintenance continue de l'adresse incluse",
                        ].map((item, index) => (
            ...
            <section className="section-dark relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
                <div className="mx-auto max-w-4xl text-center">
                    <h2 className="font-display mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-foreground">Protégez Vos Données de Directeur</h2>
                    <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl lg:text-2xl">Utilisez une adresse de service professionnelle britannique pour votre correspondance de directeur.</p>
