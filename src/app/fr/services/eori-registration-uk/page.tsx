...
export default function EORIRegistrationFR() {
    return (
        <>
            {/* ── HERO SECTION ── */}
            <section className="section-dark relative min-h-[90vh] flex flex-col justify-center overflow-hidden pt-32 pb-0 sm:pt-40 lg:pt-48">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/assets/services/eori.webp" alt="Service d'Enregistrement EORI UK" fill className="object-cover object-center" priority quality={85} />
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
                    <div className="max-w-2xl text-left">
                        ...
                        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-2 backdrop-blur-sm">
                            ...
                            <span className="text-sm font-medium text-gold">Import & Export</span>
                        </div>
                        ...
                        <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl uppercase tracking-wider font-light">
                            ENREGISTREMENT EORI UK POUR<br/>
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row">
                            ...
                            <Link href="https://buy.stripe.com/dRm28j58A5nveEBe3Ofw40n" target="_blank" className="btn-gold">
                ...
                <div className="relative z-10 mt-20 w-full border-t border-gold/20 bg-background/40 backdrop-blur-md pt-8 pb-8 hidden lg:block">
                    <div className="mx-auto max-w-7xl grid grid-cols-1 gap-8 md:grid-cols-4 px-4 sm:px-6 lg:px-8">
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">COMMERCE MONDIAL</h3>
                                <p className="text-xs text-muted-foreground">Connectez votre entreprise aux marchés internationaux</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">CONFORMITÉ COMMERCIALE</h3>
                                <p className="text-xs text-muted-foreground">Restez conforme aux réglementations douanières britanniques</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 border-r border-gold/20 pr-4 last:border-0">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                                <FaClipboardList className="h-5 w-5 text-gold" />
                            </div>
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">NUMÉRO EORI</h3>
                                <p className="text-xs text-muted-foreground">Indispensable pour l'importation et l'exportation de marchandises</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gold/30 bg-gold/5 flex-shrink-0">
                                <FaShip className="h-5 w-5 text-gold" />
                            </div>
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">IMPORT & EXPORT</h3>
                                <p className="text-xs text-muted-foreground">Optimisez vos opérations commerciales mondiales</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative z-10 mt-12 w-full border-t border-gold/20 bg-background/40 backdrop-blur-md py-6 lg:hidden overflow-x-auto snap-x snap-mandatory hide-scrollbar">
                    <div className="flex gap-6 px-4 w-max">
                        ...
                        <div className="flex items-start gap-3 snap-center w-[250px]">
                            <FaClipboardList className="h-6 w-6 text-gold flex-shrink-0 mt-1" />
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">NUMÉRO EORI</h3>
                                <p className="text-xs text-muted-foreground">Indispensable pour l'importation et l'exportation de marchandises</p>
                            </div>
                        ...
                        <div className="flex items-start gap-3 snap-center w-[250px]">
                            <FaShip className="h-6 w-6 text-gold flex-shrink-0 mt-1" />
                            <div>
                                <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">IMPORT & EXPORT</h3>
                                <p className="text-xs text-muted-foreground">Optimisez vos opérations commerciales mondiales</p>
                            </div>
            ...
            <section className="section-parchment relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 text-center">
                        <span className="text-xs font-bold tracking-[0.25em] text-gold uppercase mb-3 block">L'EORI EXPLIQUÉ</span>
                        <h2 className="font-display mb-6 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-foreground">Qu'est-ce qu'un Numéro EORI ?</h2>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-border bg-card/25 p-8 backdrop-blur-md transition-all duration-500 hover:border-gold/40 sm:p-10">
                        <div className="space-y-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
                            <p>Un numéro EORI (Economic Operators Registration and Identification) est requis pour toute entreprise qui importe ou exporte des marchandises vers ou depuis le Royaume-Uni. Sans numéro EORI, vos expéditions peuvent être retardées à la douane.</p>
                            <p>Notre service d'enregistrement EORI gère le processus de demande avec HMRC, en s'assurant que votre entreprise est prête pour le commerce international rapidement et en toute conformité.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mx-auto max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        {[
                            "Demande d'Enregistrement EORI HMRC",
                            "Numéro EORI pour le Commerce au Royaume-Uni",
                            "Conseils de Conformité Douanière",
                            "Assistance pour les Entreprises Non-Résidentes",
                            "Préparation à l'Import/Export",
                            "Traitement Rapide",
                        ].map((item, index) => (
            ...
            <section className="section-dark relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
                <div className="mx-auto max-w-4xl text-center">
                    <h2 className="font-display mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-foreground">Prêt à Commercer à l'International ?</h2>
                    <p className="mb-10 text-lg leading-relaxed text-foreground/80 sm:text-xl lg:text-2xl">Obtenez votre numéro EORI et commencez à importer et exporter.</p>
