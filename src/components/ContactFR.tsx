    ...
    const cards = [
        {
            ...
            heading: "NOUS ENVOYER UN EMAIL",
            link: { href: "mailto:contact@sevenoakprestige.com", label: "contact@sevenoakprestige.com", external: false },
            desc: "Envoyez-nous un email à tout moment — notre équipe vous répondra dans les 24 heures.",
        },
        {
            icon: (
            ...
            desc: "Discutez instantanément avec notre équipe pour des conseils rapides. Disponible 24/7.",
        },
        {
            icon: (
            ...
            desc: "Assistance basée au Royaume-Uni pour les demandes professionnelles.",
        },
    ];
        ...
        <section id="contact" className="relative overflow-hidden px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mt-20 max-w-2xl mx-auto">
                    <LeadForm source="Main Contact Page (FR)" title="Envoyez-nous un message" />
                </div>
            </div>
        </section>
    );
